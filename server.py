...
from screeninfo import get_monitors # It will fetch the location and size of the physical screen
import autopy # It will let you control the keyboard and mouse like pynput
        ...
        try:
            ...
            if message:
                ...
                if newMessage["data"] == "left_click":
                    ...
                    xpos = newMessage["data"][0]*screen_width # 20 % 'REMOTE MOUSE' , 20% 'Left click and right'
...
def acceptConnections():
    ...
    while True:
        ...
        thread = Thread(target=receiveMessages, args = (client_socket))
        thread.start()
